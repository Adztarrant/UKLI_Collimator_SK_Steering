...
void cos_twoscales_noise_dr()
{
   ...
   auto gr1=(TGraphErrors*)_file0->Get("gNoise");
   gr1->Draw("ap");
...
//   gr1->SetMarkerStyle(1);
   ...
   TFile *file0 = TFile::Open("sk5dr_shift.root");
   ...
   legend->AddEntry(gr1,"B1 collimator data","lac");
   ...
   img->FromPad(c1);
   img->WriteImage("plots/noise.png");
}
