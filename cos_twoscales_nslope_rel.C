...
void cos_twoscales_nslope_rel(int inj=1)
{
...
//   mg->SetTitle("Exclusion graphs");
   ...
   auto gr1=(TGraphErrors*)_file0->Get("gNSlope");
   mg->Add(gr1);
   mg->Draw("ap");
   ...
   yaxis->SetTitle("#frac{N_{n}/k_{n}}{ N_{0}/k_{0}}");
...
*/
   ...
   char filename[200];
   sprintf(filename,"B%d collimator data",inj);
   legend->AddEntry(gr1,filename,"lep");
   ...
   img->FromPad(c1);
   img->WriteImage("plots/nslope.png");
}
