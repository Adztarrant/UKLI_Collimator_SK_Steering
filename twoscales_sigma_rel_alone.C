...
void twoscales_sigma_rel_alone()
{
...
/*   TFile *file1 = TFile::Open("supply_bacteria.root");
   ...
   TFile *file0 = TFile::Open("return_bacteria.root");
...
*/
   ...
   img->FromPad(c1);
   img->WriteImage("plots/SpotWidth.png");
